...
const CONFIG = {
  ...
  SHEET_MAP: {
    "EPM_TestCLogin": {
      ...
      fieldCol: "Field/Control ",       
      typeCol: "Test Type",
      preCol: "Preconditions",
      stepsCol: "Test Steps",
      dataCol: "Test Data",
      expectedCol: "Expected Result",
      statusCol: "Status (Pass/Fail/Blocked)",  
      actualResultCol: "Actual Result"          
    },
